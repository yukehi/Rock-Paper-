...
$('.circle').click(function () {
    ...
    if (slected === 'spock') {
        ...
        setTimeout(function () {
            battle(slected, randomEnemy, playerScore);
        }, 2000);
...
function createBattle(playerSlction, enemySlction) {
    ...
    BorderChange(playerSlction,enemySlction);
}
...
function BorderChange(player,enemy){
    $('.player').addClass(player);
    $('.enmey').addClass(enemy);
